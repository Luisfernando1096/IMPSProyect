...
const exphbs = require('express-handlebars'); // Necesario para utilizar el motor e plantillas handlebars
...
// ===== MIDDLEWARES ===
app.use(session({
    secret: process.env.SESSION_KEY, // Esta es la clave secreta de la sesio
...
app.use(express.urlencoded({ extended: false })); // Sirve para poder aceptardatos desde formularios
